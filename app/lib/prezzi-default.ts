...
export const DEFAULT_PREZZI: Servizio[] = [
  ...
  },
  {
    ...
    desc: "Apertura Partita IVA professionista (gestione separata INPS o cassa privata) senza contabilità annuale. Per chi ha già un commercialista per la gestione e vuole solo l'apertura fatta bene.",
    price: 183,
    originalPrice: null,
    active: true,

      ...
      <main className="pt-32 pb-24">
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-custom space-y-6 text-zinc-700 leading-relaxed">
            ...
            <ul className="space-y-2 ml-4">
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/concordato-semplificato-liquidazione-2026" className="text-[var(--color-accent)] hover:underline">Concordato semplificato 2026</Link> &mdash; lo sbocco liquidatorio della composizione negoziata fallita (art. 25-sexies CCII), senza voto dei creditori</span></li>
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/adeguati-assetti-indici-crisi-2026" className="text-[var(--color-accent)] hover:underline">Adeguati assetti e indici della crisi 2026</Link> &mdash; gli obblighi organizzativi (art. 2086 c.c. e art. 13 CCII) per rilevare la crisi per tempo</span></li>

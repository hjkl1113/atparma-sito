          ...
          <div className="prose-custom space-y-6 text-zinc-700 leading-relaxed">
            ...
            <div className="bg-zinc-50 rounded-xl p-6 my-8 border border-zinc-100">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><a href="#chi-non-puo" className="text-[var(--color-accent)] hover:underline">Chi non puo usare il 730</a></li>
                ...
                <li><a href="#detrazioni-dimenticate" className="text-[var(--color-accent)] hover:underline">Le 10 detrazioni piu dimenticate</a></li>
            ...
            <p>
              Questo significa che se hai diritto a un rimborso, lo ricevi gia a partire da luglio (per i dipendenti) o da agosto-settembre (per i pensionati), proporzionalmente alla data di presentazione della dichiarazione.
            </p>
            ...
            <p>
              La presentazione del 730 e <strong>obbligatoria</strong> in diversi casi. In altri e facoltativa, ma comunque conveniente perche permette di recuperare imposte pagate in eccesso. Ecco i casi principali:
            </p>
            <p><strong>E obbligatorio presentare il 730 se:</strong></p>
            <ul className="space-y-2 ml-4">
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span>Hai avuto <strong>piu di un datore di lavoro</strong> nel corso del 2025 e le ritenute non sono state ricalcolate</span></li>
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span>Hai percepito <strong>indennita INPS</strong> (cassa integrazione, disoccupazione NASpI) senza conguaglio</span></li>
            </ul>
            ...
            <h2 id="chi-non-puo" className="text-xl font-semibold text-zinc-900 mt-10 mb-4 font-[family-name:var(--font-heading)]">
              Chi non puo usare il modello 730
            </h2>
            <p>
              Non possono utilizzare il 730 i contribuenti che hanno aperto una <strong>Partita IVA</strong> (anche in regime forfettario), chi ha redditi da impresa o lavoro autonomo professionale, e chi deve presentare dichiarazioni per trust, societa di persone o soggetti non residenti senza sostituto d&apos;imposta. In questi casi va utilizzato il <strong>modello Redditi PF</strong>.
            </p>
            <p>
            ...
            <p className="mt-4">
              <strong>Consiglio:</strong> non aspettare settembre. Chi presenta il 730 entro giugno riceve il rimborso gia nella busta paga di luglio. Chi aspetta settembre rischia di ricevere il rimborso solo a fine anno o addirittura nell&apos;anno successivo.
            </p>
            ...
            <p>
              Dal 2015 l&apos;Agenzia delle Entrate mette a disposizione il <strong>730 precompilato</strong>: una dichiarazione gia parzialmente compilata con i dati in possesso del Fisco. I dati provengono da:
            </p>
            <ul className="space-y-2 ml-4">
            ...
            <p className="mt-4">
              Per accedere al precompilato serve lo SPID, la CIE (Carta d&apos;Identita Elettronica) o la CNS (Carta Nazionale dei Servizi). Si accede dal sito dell&apos;Agenzia delle Entrate nella sezione dedicata.
            </p>
            <p>
            ...
            <p>
              E la domanda che si pongono milioni di italiani ogni anno. La risposta dipende dalla complessita della tua situazione fiscale.
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-zinc-700">
                  ...
                  <tr className="border-b border-zinc-100">
                    ...
                    <td className="py-3 px-4">Solo quelle gia inserite</td>
                    <td className="py-3 pl-4">Controllo completo e ricerca attiva</td>
                  </tr>
                  <tr className="border-b border-zinc-100">
                    <td className="py-3 pr-4 font-medium">Responsabilita</td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 pl-4">Piu CU, immobili, ristrutturazioni, familiari a carico</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p>
              In pratica: se hai un solo reddito da lavoro dipendente, nessun immobile e poche spese, il precompilato puo bastare. In tutti gli altri casi, un commercialista spesso <strong>ti fa risparmiare piu di quanto costa</strong>, individuando detrazioni che non avresti trovato da solo.
            </p>
            ...
            <p>
              Ecco l&apos;elenco completo dei documenti da raccogliere prima di presentare la dichiarazione. Conservali tutti — in caso di accertamento, l&apos;Agenzia delle Entrate puo richiederli fino a 5 anni dopo.
            </p>
            ...
            <ul className="space-y-2 ml-4">
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span>Spese per attivita sportive dei figli (5-18 anni)</span></li>
            ...
            <h2 id="detrazioni-dimenticate" className="text-xl font-semibold text-zinc-900 mt-10 mb-4 font-[family-name:var(--font-heading)]">
              Le 10 detrazioni piu dimenticate dagli italiani
            </h2>
            <p>
              Ogni anno l&apos;Agenzia delle Entrate stima che i contribuenti italiani lasciano sul tavolo centinaia di milioni di euro in detrazioni non richieste. Ecco le piu comuni:
            </p>
            <ul className="space-y-3 ml-4">
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">7.</span> <span><strong>Previdenza complementare</strong> — I contributi versati sono deducibili fino a 5.164,57 euro. Un risparmio fiscale che puo valere oltre 2.000 euro.</span></li>
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">10.</span> <span><strong>Assicurazioni rischio calamita</strong> — I premi per polizze contro eventi calamitosi sugli immobili sono detraibili al 19%, senza franchigia.</span></li>
            </ul>
            ...
            <p>
              Un errore nel 730 puo costare caro: sanzioni, interessi di mora, o semplicemente un rimborso inferiore a quello che ti spettava. Ecco gli errori piu frequenti:
            </p>
            <ul className="space-y-2 ml-4">
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><strong>Non dichiarare tutti i CU:</strong> se hai cambiato lavoro durante l&apos;anno, devi inserire tutte le Certificazioni Uniche. Dimenticarne una e una delle cause piu comuni di avviso di accertamento.</span></li>
            ...
            <p className="mt-4">
              Se il rimborso supera i <strong>4.000 euro</strong>, l&apos;Agenzia delle Entrate puo effettuare controlli preventivi, allungando i tempi fino a 6 mesi. In questo caso il rimborso viene erogato direttamente dall&apos;Agenzia, non dal datore di lavoro.
            </p>
            <p>
              Se invece dalla dichiarazione emerge un debito, l&apos;importo viene trattenuto dalla busta paga o dalla pensione, con possibilita di rateizzazione fino a 5 rate (da luglio a novembre).
            </p>
            ...
            <div className="bg-zinc-50 rounded-xl p-6 my-8 border border-zinc-100">
              <p className="text-sm text-zinc-900">
                <strong>Hai gia la CU?</strong> Non aspettare settembre. Prima presenti, prima ricevi il rimborso. Il nostro servizio 730 online parte da 79 euro e include la verifica completa di tutte le detrazioni applicabili.
              </p>
            </div>
            ...
            <ul className="space-y-2 ml-4">
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/faq" className="text-[var(--color-accent)] hover:underline">Domande frequenti</Link> — risposte alle domande piu comuni sui nostri servizi</span></li>
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/servizi/consulenza-fiscale" className="text-[var(--color-accent)] hover:underline">Consulenza fiscale</Link> — per esigenze piu complesse oltre il 730</span></li>
            </ul>

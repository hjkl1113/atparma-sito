      ...
      <main className="pt-32 pb-24">
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-custom space-y-6 text-zinc-700 leading-relaxed">
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-zinc-700">
                  ...
                  <tr className="border-b border-zinc-100">
                    ...
                    <td className="py-3 pl-4">Da 549 euro (bundle apertura + contabilità annuale)</td>
                  </tr>
                  <tr className="border-b border-zinc-100">
            ...
            <p className="mt-4">
              Il bundle Professionista forfettario (apertura + contabilità annuale + EFAT + dichiarazione redditi) parte da <strong>549 euro primo anno</strong>, rinnovo annuale o triennale a prezzo bloccato. L&apos;apertura si completa in 2-5 giorni lavorativi dalla firma del mandato.
            </p>
            ...
            <div className="bg-[var(--color-surface)] rounded-2xl p-8 mt-10 text-center">
              ...
              <p className="text-sm text-zinc-600 mb-4">
                Il nostro team di dottori commercialisti ti guida nella scelta del regime fiscale, del codice ATECO e gestisce tutta la pratica online. Bundle Professionista forfettario da 549 euro primo anno (apertura + contabilità annuale), interamente da remoto.
              </p>

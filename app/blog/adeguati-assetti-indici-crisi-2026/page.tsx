      ...
      <main className="pt-32 pb-24">
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-custom space-y-6 text-zinc-700 leading-relaxed">
            ...
            <p>
              Gli adeguati assetti servono a far scattare l&apos;allarme; quando i segnali si accendono, cambia lo strumento da attivare a seconda di chi e&apos; il debitore e di quanto la crisi e&apos; avanzata. Di seguito le guide sui singoli strumenti, per le imprese e per i debitori civili:
            </p>
            <ul className="space-y-2 ml-4">
              ...
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/concordato-semplificato-liquidazione-2026" className="text-[var(--color-accent)] hover:underline">Concordato semplificato 2026</Link> &mdash; la liquidazione quando la composizione negoziata non porta al risanamento</span></li>
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/concordato-minore-2026" className="text-[var(--color-accent)] hover:underline">Concordato minore 2026</Link> &mdash; la procedura per imprenditori minori, professionisti e imprese sotto soglia</span></li>
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/sovraindebitamento-2026-come-uscire-dai-debiti" className="text-[var(--color-accent)] hover:underline">Sovraindebitamento 2026</Link> &mdash; gli strumenti per il debitore civile e il consumatore sovraindebitato</span></li>
              <li className="flex gap-3"><span className="text-[var(--color-accent)] font-bold">&bull;</span> <span><Link href="/blog/esdebitazione-incapiente-2026" className="text-[var(--color-accent)] hover:underline">Esdebitazione del debitore incapiente</Link> &mdash; la cancellazione dei debiti per chi non ha nulla da offrire ai creditori</span></li>

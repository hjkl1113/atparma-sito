...
export const PRODOTTI: Record<string, ProdottoServizio> = {
  "dichiarazione-730": {
    ...
    closingCtaLabel: "Richiedi l'attivazione",
  ...
  "piva-professionista": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 549 euro alla firma del mandato (annuale o triennale). Fatturazione elettronica automatica.",
    closingBlurb:
  ...
  "piva-professionista-semplificato": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 1.647 euro alla firma del mandato. Fatturazione elettronica automatica.",
    closingBlurb:
  ...
  "piva-artigiano-commerciante": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 610 euro alla firma del mandato. Rimborsi spese e tributi pubblici a parte.",
    closingBlurb:
  ...
  "piva-artigiano-commerciante-forfettario": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 1.220 euro alla firma del mandato. Tributi pubblici pagati direttamente agli enti.",
    closingBlurb:
  ...
  "piva-artigiano-commerciante-semplificato": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 2.074 euro alla firma del mandato.",
    closingBlurb:
  ...
  "contabilita-professionista-forfettario": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 449 euro alla firma del mandato. Subentro gestito dalla segreteria.",
    closingBlurb:
  ...
  "contabilita-professionista-semplificata": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento alla firma del mandato (da 1.464 euro per casi standard). Subentro gestito dalla segreteria.",
    closingBlurb:
  ...
  "contabilita-artigiano-forfettario": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 610 euro alla firma del mandato. Subentro gestito dalla segreteria.",
    closingBlurb:
  ...
  "contabilita-artigiano-semplificata": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 1.464 euro alla firma del mandato. Subentro gestito dalla segreteria.",
    closingBlurb:
  ...
  "dichiarazione-upf-base": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 98 euro alla firma del mandato.",
    closingBlurb:
  ...
  "apertura-professionista-sola": {
    ...
    ctaNote:
      "Nessuna registrazione: apriamo noi la pratica. Pagamento 183 euro alla firma del mandato. Servizio una tantum senza vincoli.",
    closingBlurb:

...
Ultimo aggiornamento: `2026-04-21 notte (WIP parziale chiuso — rendering + claim fatti)`
...
- Rendering "a partire da €X" in `app/pricing.tsx`, `app/servizi/page.tsx`, `app/servizi/[slug]/page.tsx` FATTO (sessione Windows 2026-04-21 notte) — `priceFormat` esteso anche a `DEFAULT_PREZZI` per i 6 bundle "da"
- P2 claim "20 anni" → "Oltre 20 anni" in `app/page.tsx`, `app/blog/commercialista-online/page.tsx` e `contenuti.md` FATTO (sessione Windows 2026-04-21 notte)
